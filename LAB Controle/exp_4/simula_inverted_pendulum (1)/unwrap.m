...
%   Q = UNWRAP(P) unwraps radian phases P by changing absolute 
...
%
%   Q = UNWRAP(P,CUTOFF) compares the jump between elements of P to the
%   jump threshold CUTOFF instead of the default value pi. If you
%   specify a jump threshold less than pi, unwrap uses the default jump
%   threshold pi.
%  
%   Q = UNWRAP(P,[],DIM) unwraps along dimension DIM using the
